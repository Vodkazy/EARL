...
# -*- coding: utf-8 -*- 
"""
  @ Time     : 19-4-15 上午10:16
  @ Author   : Vodka
  @ File     : PredictRange.py
...
class Rnn(nn.Module):
    ...
    def train(self,model, X, Y, num_case):
        ...
        model.saveModel(model, '../model/range_predictor.model')

#
# if __name__ == '__main__':
#     model = Rnn(50, 50, 2, 206)
#     X = np.load('../data/net_train_x.npy')  # 2421*50
#     Y = np.load('../data/net_train_y.npy')  # 2421*269
